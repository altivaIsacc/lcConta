...
#Region " C�digo generado por el Dise�ador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label17.Text = "Descripci�n del Asiento"
    ...
    "aMadre, Movimiento, id FROM CuentaContable"
        ...
        'gcNombreCuenta
        '
        Me.gcNombreCuenta.Caption = "Descripci�n"
    ...
    "vimientos"
        ...
        Me.Text = "M�dulo Asientos Contables..."
...
#Region "Load"
    ...
    Function CrearTabla()
        ...
        Me.CrearColumnas("Descripcion", "Descripci�n", 270, 5, "Descripcion", False, False, False)
...
#Region "Controles"
    ...
    Sub ComprobarArchivoTemporal()
        ...
        If System.IO.File.Exists(Ruta & "tempAsiento.xml") Then
            Dim r = MsgBox("Hay un archivo de autorecuperaci�n de datos, �Desea cargarlo?", MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo)
    ...
    Private Sub TxtMonto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtMonto.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Catch ex As Exception
                MessageBox.Show("Verifique el formato del monto del asiento", "Atenci�n...", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
            End Try
        End If
    End Sub
        ...
        If (Not e.KeyChar.IsDigit(e.KeyChar)) Then
            If Not (e.KeyChar = Convert.ToChar(Keys.Back)) And Not (e.KeyChar = "-") And Not (e.KeyChar = "(") And Not (e.KeyChar = ")") And Not (e.KeyChar = " ") Then
                ...
                If Me.BindingContext(Me.DataSetAsientos1, "CuentaContable").Count <> 0 Then
                    ...
                    Else
                        MsgBox("El N�mero de Cuenta Ingresado no Puede ser Utilizado Para Esta Operaci�n...Por Favor Verifique", MsgBoxStyle.Exclamation, "Error de Verificaci�n")
                        Me.TxtNumCuenta.SelectAll()
                    End If
                Else
                    MsgBox("N�mero de Cuenta no Existe...Por Favor Verifique", MsgBoxStyle.Exclamation, "Error de Verificaci�n")
                    Me.TxtNumCuenta.SelectAll()
                End If
            End If
        End If
    ...
    Private Sub spCargarCierreCaja()
        Try
            ...
            'Buscar Informaci�n de Ingresos de Ventas Gravadas
            ...
            End If
            'Buscar Informaci�n de Ingresos de Ventas Excentas
            ...
            'Buscar Informaci�n de Impuesto de Ventas
            Dim cIv As String = ""
            Dim cDIv As String = ""
            ...
            'Buscar Informaci�n de Cuentas x Cobrar
            Dim cCxC As String = ""
            Dim cDCxC As String = ""
...
#Region "ToolBar"
    Private Sub ToolBar1_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles ToolBar1.ButtonClick
        ...
        Select Case ToolBar1.Buttons.IndexOf(e.Button)
            ...
            Case 3 : If PMU.Delete Then Eliminar() Else MsgBox("No tiene permiso para eliminar o anular datos...", MsgBoxStyle.Information, "Atenci�n...") : Exit Sub
...
#Region "Imprimir"
    Private Function Imprimir()
        Try
            ...
            If MsgBox("Desea Los Asientos Col�n y Dolar", MsgBoxStyle.OkCancel) = MsgBoxResult.Ok Then
        ...
        Try
            Select Case DataSetAsientos1.AsientosContables(0).TipoDoc
                ...
                Case Else
                    ...
                    MsgBox("La opci�n de ver el detalle es exclusivo para asientos autom�ticos")
    ...
    Sub sp_desbloquearDocumento()
        ...
        Select Case pTipo
            ...
            Case "Ajuste Entrada Inventario"
                ...
                modulo = "SeePOS"
            Case "Ajuste Inventario de proveedur�a" 'ASIENTO BAJADO EN FORMA AGRUPADA
                consulta = " UPDATE Proveeduria.dbo.AjusteInventario SET  ContaEntrada = 0 ,AsientoEntrada  = '0' WHERE AsientoEntrada  = '" & nAs & "' "
                modulo = "SeePOS"
    ...
    Private Function Eliminar()
        ...
        If Me.LblConsecutivo.Text <> "" Then
            If CheckBox2.CheckState = CheckState.Unchecked Then
                ...
                If MessageBox.Show(" � Desea Anular Este Asiento ? ", "Atenci�n...", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = DialogResult.No Then Exit Function
                ...
                If Resultado = vbNullString Then
                    MessageBox.Show("El Asiento Fue Anulado", "Atenci�n...", MessageBoxButtons.OK, MessageBoxIcon.Information)
            ...
            End If
        Else
            MessageBox.Show("No hay Cuenta Que Eliminar ", "Atenci�n...", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Function
#End Region
            ...
            If cFunciones.ExistenPeriodos Then
                If cFunciones.PeriodoAbiertoMenuPrincipal Then
                    If cFunciones.FechaValida(DPTrans.Value) Then
                        PeriodoValido = True
                    Else
                        MsgBox("No es posible realizar cambios en el asiento porque el periodo de trabajo ya est� cerrado.", MsgBoxStyle.Exclamation, "�Atenci�n!")
                    End If
                End If
            End If
    ...
    Private Sub Registrar()
        ...
        Try
            ...
            If Not cFunciones.FechaValida(DPTrans.Value) Then
                MsgBox("No es posible registrar el cambio en el asiento, porque la fecha seleccionada se encuentra en un periodo de trabajo cerrado. Seleccione una fecha v�lida.", MsgBoxStyle.Exclamation, "�Atenci�n!")
                Exit Sub
            End If
            '-------------------------------------------------------------------------------
        ...
        If e.KeyCode = Keys.Enter Then
            If fnValidarNoDocumentoDetalle() Then
                If txtNoDocumentoDetalle.Text.Replace(" ", "").Length = 0 Then
                    MessageBox.Show("Por favor, ingrese un n�mero de documento.", "Atenci�n", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    txtNoDocumentoDetalle.Focus()
                Else
                    If fnValidarNoDocumentoDetalleDeposito() Then
                        MessageBox.Show("El n�mero de documento ya esta registrado.", "Atenci�n", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        txtNoDocumentoDetalle.Focus()
                    Else
                        TxtMonto.Focus()
                    End If
    ...
    Private Sub ButAgregarDetalle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButAgregarDetalle.Click
        ...
        If DetallesVerificado() Then
            If Me.TxtMonto.Text <> 0 Then
                ...
                salvarTemporal()
            Else
                MsgBox("El Monto del Asiento No Puede ser Cero. Por Favor Verifique...", 16, "Error de Validaci�n de Datos...")
            End If
        Else
            MsgBox("Captura de Datos Incompleta. Por Favor Verifique...", 16, "Error de Validaci�n de Datos...")
        End If
    End Sub
...
#Region "Elimina Detalle"
    Private Sub butEliminarDetalle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butEliminarDetalle.Click
        If Me.BindingContext(DataSetAsientos1, "AsientosContables").Current("Accion") = "AUT" And Not editaAutomaticos Then
            ...
            Exit Sub
        End If
        If MessageBox.Show(" � Eliminar la cuenta ? ", "Atenci�n...", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = DialogResult.No Then Exit Sub
