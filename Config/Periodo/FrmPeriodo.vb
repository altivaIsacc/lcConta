        ...
        Try
            ...
            Select Case ToolBar1.Buttons.IndexOf(e.Button)
                ...
                Case 1
                    ...
                    Else
                        MsgBox("No tiene permiso para Buscar informaci�n...", MsgBoxStyle.Information, "Atenci�n...")
                        Exit Sub
    ...
    Public Sub Guardar()
        ...
        Try
            If Funcion.ValidarPeriodoFiscal(CDate("02" & "/" & CBMes.SelectedValue & "/" & NUDAnno.Value)) <> True Then
                MsgBox("No puede guardar el Periodo!" & vbCrLf & "!Porque no esta dentro de ning�n periodo fiscal abierto!", MsgBoxStyle.Exclamation, "Contabilidad")
                Exit Sub
            End If
        ...
        Try
            ...
            If f.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                For i As Integer = 0 To BindingContext(DsPeriodo2, "Periodo").Count - 1
                    ...
                    End If
                Next
                MsgBox("No se encontr� el periodo", MsgBoxStyle.OkOnly)
    ...
    Private Sub AccesoEditar()
        ...
        If chbCerradoFinal.Checked Or CheckCerrado.Checked Then
            ...
            Else
                ...
                CheckCerrado.Enabled = False
                btReversarCierre.Enabled = False
                MsgBox("Contrase�a de acceso incorrecta", MsgBoxStyle.Exclamation, "Acceso incorrecto")
            End If
        Else
            Editar()
        End If
