...
Public Class cFunciones
    ...
    Public Shared Function FechaMin() As DateTime
        ...
        Try
            ...
            While rs.Read
                ...
                Dim Año As Integer = rs("Anno")
                FechaMinimaPeriodo = "1/" & Mes & "/" & Año
    ...
    Public Shared Function FechaMax() As DateTime
        ...
        Try
            ...
            While rs.Read
                ...
                Dim Mes As Integer = rs("Mes")
                Dim Año As Integer = rs("Anno")
                FechaMaxPeriodo = "1/" & Mes & "/" & Año '01/10/2020
    ...
    Public Shared Function ValidarExistePeriodo() As Boolean
        ...
        Try
            ...
            While rs.Read
                ...
                Else
                    MsgBox("No existen periodos de trabajo registrados. Para crear un nuevo periodo, se debe dirigir al men� principal de contabilidad y seguir la ruta: Operaciones -> Periodo de Trabajo. ", MsgBoxStyle.Exclamation, "Atenci�n...")
                End If
            End While
            rs.Close()
    ...
    Public Shared Function PeriodoAbiertoMenuPrincipal() As Boolean 'SE MUESTRA SI NO HAY PERIODOS ABIERTOS'
        ...
        Else
            MsgBox("No existen periodos de trabajo abiertos. Para ingresar un nuevo periodo, se debe dirigir al men� principal de contabilidad y seguir la ruta: Operaciones -> Periodo de Trabajo.", MsgBoxStyle.Exclamation, "�Atenci�n!")
    ...
    Public Shared Function ExistenPeriodos() As Boolean 'SI HAY ALGUN PERIODO REGISTRADO
        ...
        Else
            MsgBox("No existen periodos de trabajo. Para ingresar un nuevo periodo, se debe dirigir al men� principal de contabilidad y seguir la ruta: Operaciones -> Periodo de Trabajo.", MsgBoxStyle.Exclamation, "�Atenci�n!")
    ...
    Public Shared Function ValidarAccesoEditar() As Boolean 'ACCESO PARA EDITAR UN PERIODO
        ...
        Else
            MsgBox("Lo sentimos contrase�a incorrecta", MsgBoxStyle.Exclamation, "�Atenci�n!")
